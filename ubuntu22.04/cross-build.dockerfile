...
ENV TOOLCHAIN=x86_64-linux-gnu \
    ...
    BUILD_CONFIG="release cxxstd=17 crypto=openssl webtorrent=off warnings=off toolset=gcc-amd64 address-model=64"
...
ENV TOOLCHAIN=aarch64-linux-gnu \
    ...
    BUILD_CONFIG="release cxxstd=17 crypto=openssl webtorrent=off warnings=off toolset=gcc-arm64 address-model=64"
...
ENV TOOLCHAIN=arm-linux-gnueabihf \
    ...
    BUILD_CONFIG="release cxxstd=17 crypto=openssl webtorrent=off warnings=off toolset=gcc-armhf address-model=32"
